...
func ID(id int) predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}

// IDEQ applies the EQ predicate on the ID field.
func IDEQ(id int) predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
...
func IDLT(id int) predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
...
func HasImages() predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
...
func HasImagesWith(preds ...predicate.Image) predicate.ImageRepo {
	return predicate.ImageRepo(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
